...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "Everything in Free",
      "Unlimited secure cloud sync across all your devices",
      "Unlimited cloud snippets & collections, with snippet version history",
  ...
  },
  {
    ...
    features: [
      ...
      "SSO / SAML and audit log (coming soon)",
